...
public class Getssh {
    private static final Logger log = LoggerFactory.getLogger(Getssh.class);
    /*
     * @Description:
     * @Param:
     * @return:
...
//		int port = 1022;
        String result = null;
        System.out.println(filepath + "............." + password);
        try {
            ...
            for (int i = 1; i < num; i++) {
                ...
                log.info("portforwarding: " + "localhost:" + assinged_port + " -> " + other[2] + ":" + 1022);
