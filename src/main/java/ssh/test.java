...
public class test {
   ...
   //     String[] ech={"root:123456a:service.dev.jisuqianbao.com:2201","super_test:guI8jFbIMB2OWKqQ:rm-uf6nk81i4p1bk1whn.mysql.rds.aliyuncs.com:3306"};
        String[] ech={"ua_lbd_test:L6UC7oLpVS23:10.0.6.11:3306"};
       String a= Database.database(9106,"D:\\\\xshell\\\\id_rsa_2048-private","select id from t_platform_enquiry where source_code='WTD20190508190005'",
                "com.mysql.jdbc.Driver","jdbc:mysql://localhost:3306/logistics_blm_bidding","user_id",ech);
