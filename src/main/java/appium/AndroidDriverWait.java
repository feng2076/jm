 ...
 * @Date: 2018/11/5 
 */
	public AndroidDriverWait(AndroidDriver driver, Clock clock,
			Sleeper sleeper, long timeOutInSeconds, long sleepTimeOut) {
	...
	protected RuntimeException timeoutException(String message,
		...
		if (driver instanceof RemoteWebDriver) {
			...
			if (remote.getSessionId() != null) {
				ex.addInfo(WebDriverException.SESSION_ID, remote.getSessionId()
						.toString());
			}
